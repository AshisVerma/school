        ...
        <ul class="nav">
          ...
          <li class="nav-item d-none d-lg-block">
            ...
            <div class="collapse" id="sidebar-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('/feetype')?>">Fee Type</a></li>
                 <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('/feecategory')?>">Fee Category</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('/feegroup')?>">Fee Group</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/layout/sidebar-hidden.html">Fee Master </a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/layout/sidebar-hidden-overlay.html">Fee Discount</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/layout/sidebar-fixed.html">Fee Remainder</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/layout/sidebar-fixed.html">Fee Forward</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
